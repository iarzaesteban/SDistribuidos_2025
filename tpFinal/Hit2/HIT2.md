...
La solución fue encontrar la versión máxima soportada por la GPU (CUDA 11.x) y planear descargar e instalar **CUDA Toolkit 11.8** con el instalador local offline, evitando el network installer que daba errores.
...
El entorno online de **godbolt.org** fue útil para probar y depurar código CUDA sin necesidad de tener el toolkit instalado localmente.
